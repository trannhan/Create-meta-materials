...
#mpirun -np $NSLOTS ./scat -a 0.000001 -d 0.0001 -n 1000000 -p 125 -c 8000 >${JOB_NAME}/output11 2>${JOB_NAME}/error11
#mpirun -np $NSLOTS ./scat -a 0.000001 -d 0.00001 -n 1000000 -p 125 -c 8000 >${JOB_NAME}/output13 2>${JOB_NAME}/error13
#mpirun -np $NSLOTS ./scat -a 0.000001 -d 0.000001 -n 1000000 -p 125 -c 8000 >${JOB_NAME}/output14 2>${JOB_NAME}/error14
mpirun -np $NSLOTS ./scat -a 0.000001 -d 0.000003 -n 1000000 -p 125 -c 8000 >${JOB_NAME}/output15 2>${JOB_NAME}/error15
mpirun -np $NSLOTS ./scat -a 0.000001 -d 0.000006 -n 1000000 -p 125 -c 8000 >${JOB_NAME}/output16 2>${JOB_NAME}/error16
mpirun -np $NSLOTS ./scat -a 0.000001 -d 0.000008 -n 1000000 -p 125 -c 8000 >${JOB_NAME}/output17 2>${JOB_NAME}/error17
